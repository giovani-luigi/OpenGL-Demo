...
inline std::ostream& operator<<(std::ostream& out, const Matrix4x4& m) {
	return
		...
		<< "[" << setw(6) << m[0] << "][" << setw(6) << m[1] << "][" << setw(6) << m[2] << "][" << setw(6) << m[3] << "]" << std::endl
		<< "[" << setw(6) << m[4] << "][" << setw(6) << m[5] << "][" << setw(6) << m[6] << "][" << setw(6) << m[7] << "]" << std::endl
		<< "[" << setw(6) << m[8] << "][" << setw(6) << m[9] << "][" << setw(6) << m[10] << "][" << setw(6) << m[11] << "]" << std::endl
		<< "[" << setw(6) << m[12] << "][" << setw(6) << m[13] << "][" << setw(9) << m[14] << "][" << setw(6) << m[15] << "]" << std::endl
		<< std::endl;
}
