...
{
	float t;
	t = m_Array[1]; m_Array[1] = m_Array[4]; m_Array[4] = t;
	t = m_Array[2]; m_Array[2] = m_Array[8]; m_Array[8] = t;
	t = m_Array[3]; m_Array[3] = m_Array[12]; m_Array[12] = t;
	t = m_Array[6]; m_Array[6] = m_Array[9]; m_Array[9] = t;
	t = m_Array[7]; m_Array[7] = m_Array[13]; m_Array[13] = t;
	t = m_Array[11];m_Array[11] = m_Array[14]; m_Array[14] = t;
}
